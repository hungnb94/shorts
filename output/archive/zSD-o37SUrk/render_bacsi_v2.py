#!/usr/bin/env python3
"""Render 3 Bác sĩ Hải Shorts: Mode-A Verbatim."""
import subprocess, shutil, json
from pathlib import Path

SRC = Path("output/zSD-o37SUrk/zSD-o37SUrk_2160p.mp4")
...
# === 3 VARIANTS (Verified Timestamps) ===
VARIANTS = [
    {"id": "V1_ngu_ngon", "src_start": 30.0, "src_end": 85.0, "hook": "TẠI SAO BẠN HAY THỨC DẬY GIỮA ĐÊM?", "cta": "FOLLOW ĐỂ NGỦ NGON HƠN!", "pexels": [(5,3,"bedroom"),(15,3,"ac"),(40,3,"sleepwell")]},
    {"id": "V2_mat_ngu", "src_start": 200.0, "src_end": 253.0, "hook": "ĐỪNG CẦM ĐIỆN THOẠI KHI MẤT NGỦ", "cta": "FOLLOW ĐỂ KHÔNG MẤT NGỦ!", "pexels": [(5,3,"phone"),(20,3,"clock"),(35,3,"sleepless")]},
    {"id": "V3_tho_178", "src_start": 350.0, "src_end": 401.0, "hook": "KỸ THUẬT THỞ 1-7-8 ĐỂ NGỦ NGAY", "cta": "FOLLOW ĐỂ THỬ KỸ THUẬT NÀY!", "pexels": [(5,3,"breathing"),(20,3,"sleepwell"),(35,3,"bedroom")]},
]
