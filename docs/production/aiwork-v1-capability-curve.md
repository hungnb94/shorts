...
- File: `output/projects/aiwork/final/capability_curve_v1.mp4` (10.5MB)
...
## YouTube Description
See `output/projects/aiwork/final/capability_curve_v1.txt` (credits the source channel per ADR-0021's brand-sensitivity mitigation).
