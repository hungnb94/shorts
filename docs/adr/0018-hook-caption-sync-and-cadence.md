...
**Date:** 2026-07-10
**Status:** Accepted (cadence amended by ADR-0036)

**2026-07-24 amendment:** ADR-0036 keeps this ADR's caption-sync gate but replaces the 1–2s hook cadence with a 0.8–1.5s production target for final t=0–5s plus separate later-window ceilings. The original benchmark evidence below remains historical context.
...
2. **Target at least one Visual Change every 0.8–1.5s in final t=0–5s** — a cut, reframe/zoom, overlay change, layout/source change or continuous motion reset counts. ADR-0036 owns the later-window ceilings and the separate Information Progression Gate.

The caption rule remains stricter than ADR-0017 and applies narrowly to the hook window. ADR-0036 now owns project-wide cadence after amending ADR-0016 and this ADR's original cadence threshold.
